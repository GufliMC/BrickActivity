...
class ActivityEventSubscriptionBuilder<T extends Event> extends EventSubscription.Builder<T> {

    private final Activity activity;
    private final Class<T> eventClass;

    ActivityEventSubscriptionBuilder(@NotNull Activity activity, @NotNull Class<T> eventClass) {
